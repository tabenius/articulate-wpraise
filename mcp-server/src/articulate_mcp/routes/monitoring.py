...
async def health_endpoint(request):
    ...
    from articulate_mcp.health import get_liveness_status
...
async def health_ready_endpoint(request):
    ...
    from articulate_mcp.health import get_readiness_status
...
async def health_deep_endpoint(request):
    ...
    from articulate_mcp.health import get_health_status
...
async def profiling_stats_endpoint(request):
    ...
    from articulate_mcp.profiling import get_profiling_stats
