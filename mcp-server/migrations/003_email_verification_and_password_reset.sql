...
UPDATE articulate_users_auth SET email_verified = TRUE WHERE email_verified = FALSE;

CREATE TABLE IF NOT EXISTS articulate_password_reset_tokens (
...
CREATE TABLE IF NOT EXISTS articulate_login_tokens (
    id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    user_id BIGINT(20) UNSIGNED NOT NULL,
