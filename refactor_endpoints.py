...
with open('/home/xyzzy/wp-ai/mcp-server/src/wp_mcp/server.py', 'r') as f:
    content = f.read()
...
pattern = re.compile(
    ...
    r'(from wp_mcp\.user_manager import UserManager\n.*?)'  # UserManager import
...
def refactor_match(match):
    ...
    before_clean = user_manager_import.replace('from wp_mcp.user_manager import UserManager\n    ', '')
